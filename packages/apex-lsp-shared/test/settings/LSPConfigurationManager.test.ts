...
describe('LSPConfigurationManager', () => {
  ...
  beforeEach(() => {
    ...
    mockSettingsManager = {
      ...
      getEnableStartupProfiling: jest.fn().mockReturnValue(false),
      setEnableStartupProfiling: jest.fn().mockReturnValue(true),
      getEnableInteractiveProfiling: jest.fn().mockReturnValue(false),
      setEnableInteractiveProfiling: jest.fn().mockReturnValue(true),
