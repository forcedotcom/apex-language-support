...
import { Cause, Effect, Schema, Deferred } from 'effect';
import {
  WorkerInit,
  PingWorker,
...
import {
  resolveLocalRename,
  resolvePrepareRenameForLocal,
  resolveFieldRename,
  resolvePrepareRenameForField,
  resolveMethodRename,
...
import {
  ...
  type CursorOccurrence,
} from './worker/cursorResolution.ts';
import { fullDetailCursorBySymbolManager } from './worker/fullDetailCursorCache.ts';
import {
  resolveMissingNamesViaDataOwner,
  hasCompleteLocalSymbolTable,
  recompileCursorFileAtFullDetail,
  loadReferencedTypesForFile,
} from './worker/crossFileResolution.ts';

// Cross-file resolution substrate lives in ./worker/crossFileResolution.ts.
// Re-exported here to preserve the public surface consumed by the platform
// shells and tests.
export {
  resolveMissingNamesViaDataOwner,
  recompileCursorFileAtFullDetail,
...
// Cursor / occurrence / declaration-range resolution substrate lives in
// ./worker/cursorResolution.ts. Re-exported here to preserve the public
// surface consumed by the platform shells and tests.
export {
  exactCursorReference,
  resolveCursorSymbol,
  declaringFileForCursorSymbol,
...
export type { OccurrenceRange, CursorOccurrence };
...
// ---------------------------------------------------------------------------
// Data-owner concurrency substrate (tiered queue + readiness latches)
//
// Definitions live in ./worker/dataOwnerQueue.ts and are imported at the top
// of this module. Re-exported here to preserve the public surface consumed by
// the handlers and tests.
// ---------------------------------------------------------------------------
...
export type { DOQueueItem, DOQueues, ReadinessLatch };
