...
describe('ApexSymbolManager - Enhanced Resolution', () => {
  ...
  const activeResolutionGroup = process.env.APEX_RESOLUTION_GROUP ?? 'none';
  const shouldRunResolutionGroup = (...groups: string[]): boolean =>
    activeResolutionGroup === 'all' || groups.includes(activeResolutionGroup);
  ...
  describeResolutionGroup(['core'], 'resolveSymbolWithStrategy', () => {
  ...
  describeResolutionGroup(['core'], 'getSymbolAtPosition - Enhanced', () => {
  ...
  describeResolutionGroup(
    ['qualified'],
    'Qualified Name Hover Resolution',
    () => {
      beforeAll(async () => {
  ...
  describeResolutionGroup(
    ['methods'],
    'Method Name Resolution in Qualified Calls',
    () => {
      beforeEach(async () => {
        // Initialize services for this describe block
        symbolManager = new ApexSymbolManager();
  ...
  describeResolutionGroup(
    ['methods'],
    'Method Signature Parameter Type Resolution',
    () => {
      beforeAll(async () => {
        useSharedManager = true;
        symbolManager = new ApexSymbolManager();
      ...
      describe('Builtin Type Parameter Resolution', () => {
        ...
        it('should resolve List parameter type in method signature', async () => {
          ...
          // Position cursor on "List" parameter type in
          // "public List<String> process(List<String> items, Integer count)"
  ...
  describeResolutionGroup(
    ['declarations'],
    'Field/Property/Variable Declaration Type Resolution',
    () => {
      beforeAll(async () => {
        // Initialize services for this describe block
        useSharedManager = true;
